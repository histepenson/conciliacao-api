...
Campos por linha (compativel com CTBR400 / CTBR480):
  ...
  debito, credito, saldo_atual, conta, ct2_key, ct2_lp, ct2_origem, ct2_sequen
...
Begin Sequence
    ...
    While !(cAlias)->(Eof())
        ...
        // Sequencia do LP (CT5_SEQUEN): prefixo "LP-SEQ" do CT2_ORIGEM (ex.: "650-002 - usuario").
        // Sem JOIN na CT5 -- este fonte existe pra ser leve; o ZCT2RAZCT5 faz o JOIN quando precisa da descricao.
        oLinha["ct2_sequen"]         := IIf(SubStr((cAlias)->CT2_ORIGEM,4,1) == "-", AllTrim(SubStr((cAlias)->CT2_ORIGEM,5,3)), "")
