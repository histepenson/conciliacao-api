...
ElseIf !Empty(cFilialDe) .And. !Empty(cFilialAte)
	cSql += "   AND SE1.E1_FILORIG BETWEEN '" + PadR(cFilialDe, TamSX3("E1_FILIAL")[1]) + "' AND '" + PadR(cFilialAte, TamSX3("E1_FILIAL")[1]) + "' "
EndIf
...
Begin Sequence
	...
	If !lHasMore .And. nAbatimentos != 3 .And. (!Empty(cMvAbatim) .Or. !Empty(cMvFuAbt))
		...
		ElseIf !Empty(cFilialDe) .And. !Empty(cFilialAte)
			cSqlAbat += "   AND SE1.E1_FILORIG BETWEEN '" + PadR(cFilialDe, TamSX3("E1_FILIAL")[1]) + "' AND '" + PadR(cFilialAte, TamSX3("E1_FILIAL")[1]) + "' "
		EndIf
...
EndIf
	...
	If !lHasMore .And. nPar43 == 1
		...
		ElseIf !Empty(cFilialDe) .And. !Empty(cFilialAte)
			cSqlFJU += "   AND SE1.E1_FILORIG BETWEEN '" + PadR(cFilialDe, TamSX3("E1_FILIAL")[1]) + "' AND '" + PadR(cFilialAte, TamSX3("E1_FILIAL")[1]) + "' "
		EndIf
