...
from routers.matching_manual_estoque_router import router as matching_manual_estoque_router
...
app.include_router(matching_manual_estoque_router, prefix="/api")
