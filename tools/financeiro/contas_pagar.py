...
def normalizar_planilha_contas_pagar(entrada: Any, considera_loja: bool = True) -> pd.DataFrame:
    """
...
def normalizar_planilha_contas_pagar_detalhada(entrada: Any, considera_loja: bool = True) -> pd.DataFrame:
    """
